...
import com.example.w24_3175_g7_onroadsavior.ProviderRequetsAdapter;
...
public class ProviderRequestHistoryAdapter extends RecyclerView.Adapter<ProviderRequestHistoryAdapter.RequestViewHolder> {
    ...
    @NonNull
    @Override
    public ProviderRequestHistoryAdapter.RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.service_provider_history_request, parent, false);
        return new ProviderRequestHistoryAdapter.RequestViewHolder(v, providerRequestHistoryInterface);
    }

    @Override
    public void onBindViewHolder(@NonNull ProviderRequestHistoryAdapter.RequestViewHolder holder, int position) {
